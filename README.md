# Girls Nite Ouch! - Nebula Arena 🐍✨

Repositori ini memuat *website* pendaftaran turnamen komunitas **Black Mamba**, bertema "Girls Nite Ouch! — Dueling Ground 1v1". Desain dibangun dengan konsep *Cyberpunk/Neon*, menggunakan palet warna *Deep Purple*, *Neon Pink*, dan *Neon Yellow* yang berfokus pada pengalaman *mobile-first*.
...
- `/` : Akar (*root*) utama *website*.
  ...
  - `/js/app.js` : Sentra logika interaksi, validasi *form*, dan *localStorage*.
  - `/assets/` : Aset gambar/logo.
- `/rules/` : Cadangan salinan *markdown* mentah untuk peraturan.

## 💻 Cara Menjalankan Secara Lokal
Situs ini adalah statis murni tanpa ketergantungan (dependensi) *backend* atau *Node.js* kompleks. Anda bisa menjalankannya langsung di peramban web mana saja.
1. *Clone* repositori ini.
2. Buka file `index.html` pada peramban web Anda.
3. Seluruh alur mulai dari mengisi form hingga melihat hasil di `admin.html` akan langsung bekerja dengan menyimpan data di dalam memori lokal (*browser's localStorage*).
